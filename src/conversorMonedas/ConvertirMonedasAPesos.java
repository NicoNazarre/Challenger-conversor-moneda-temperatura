...
public class ConvertirMonedasAPesos {
	public void ConvertirDolaresAPesos(double valor) {
		double monedaDolar = valor * 580.00;
		monedaDolar = (double) Math.round(monedaDolar *100d)/100;
        JOptionPane.showMessageDialog(null, "Tienes $ " +monedaDolar+ 
        		" Pesos Argentinos");
	}
	...
	public void ConvertirEurosAPesos(double valor) {
		...
		JOptionPane.showMessageDialog(null, "Tienes $ " +monedaEuro+ 
				" Pesos Argentinos");
	}
	...
	public void ConvertirYenAPesos(double valor) {
        ...
        JOptionPane.showMessageDialog(null, "Tienes $ " +monedaYen+ 
        		" Pesos Argentinos");
	}
	...
	public void ConvertirWonAPesos(double valor) {
        ...
        JOptionPane.showMessageDialog(null, "Tienes $ " +monedaWon+ 
        		" Pesos Argentinos");
	}
}
